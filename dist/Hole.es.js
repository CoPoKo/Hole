...
class HoleContext {
  ...
  setlike() {
    ...
    for (const key in like) {
      (_a = document.querySelector("[myid='" + key + "']")) == null ? void 0 : _a.classList.add("liked");
    }
  }
}
/*!
